...
const Card = styled.div`
  ${tw`flex flex-col mx-auto max-w-xs items-center px-6 py-10 border-8 border-green-500 rounded-lg mt-12`}
  .imageContainer {
