...
import { Container, ContentWithPadding } from "components/misc/Layouts.js";
...
`;
const Testimonial = tw.div`py-12 sm:px-20 sm:py-16 focus:outline-none flex! flex-col justify-between h-full`
